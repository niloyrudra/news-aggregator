...
API keys are embedded in the built JavaScript bundle and can be read by anyone using browser developer tools. This is a known, deliberate trade-off as specified in agent-skills/04-security-and-reliability.md.
